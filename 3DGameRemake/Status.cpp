...
namespace CHARA_STATUS {
	CharacterStatus PLAYER = { 100, 0.015f, 0.9f, 0.5f, 2.0f, 1.0f,1.8f,0.8f,TEAMID::ID_FRIENDLY, 0};
	CharacterStatus DUMMY = { 10000,0.0f,0.0f,1.0f,2.0f,2.0f,1.8f,1.8f, TEAMID::ID_ENEMY, 0 };
	CharacterStatus MELEE_ENEMY = { 2,0.023f,0.8f,0.5f,2.0f,2.0f,1.8f,1.8f,TEAMID::ID_ENEMY , 100};
	CharacterStatus RIFLE_ENEMY = { 10,0.012f,0.8f,0.5f,2.0f,2.0f,1.8f,1.8f,TEAMID::ID_ENEMY , 150};
	CharacterStatus SNIPER_ENEMY = { 10,0.01f,0.8f,0.5f,1.5f,1.5f,1.3f,1.3f,TEAMID::ID_ENEMY , 150};
	CharacterStatus ROLL_ENEMY = { 3, 0.01f, 0.95f, 0.5f,0.5f, 0.5f, 0.5f, 0.5f, TEAMID::ID_ENEMY, 50};
}
