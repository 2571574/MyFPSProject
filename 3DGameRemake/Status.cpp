...
namespace PLAYER_GUN {
	...
	GunStatus SMG = { WeaponID::SMG, false, false, true, false, 15, 40.0f, 40, 240, 1.8f, 20.0f, 0.1f, 0.03f, 1.5f, VGet(0.4f,-0.2f,1.55f),VGet(0.0f,0.0f,1.0f), 1.0f, 0.7f, 60.0f,0.06f,1.0f,0,0,false,
						{"Resource/Weapon/SMG.mv1",0.005f,VGet(0.5f,-0.6f,0.5f),VGet(0.0f,-0.49f,0.7f), VGet(0.4f,-0.2f, 1.55f),VGet(0.0f,-0.12f,1.55f),"Resource/WeaponUI/SMG.png","Resource/Sound/FireSMG.ogg","Resource/Sound/Reload.wav","Resource/Sound/Reloadend.wav"} };
	...
	GunStatus PISTOL = { WeaponID::PIS, false, false, false, true, 35, 40.0f, 8, 0, 2.0f, 8.0f, 0.05f, 0.005f, 3.0f,VGet(0.5f,-0.25f,1.3f),VGet(0.0f,0.0f,1.0f),1.0f,0.8f,60.0f,0.06f,1.0f,0,0,false,
						{"Resource/Weapon/PIS.mv1",0.005f,VGet(0.5f,-0.55f,0.6f),VGet(0.0f,-0.36f,0.4f), VGet(0.5f,-0.25f,1.3f),VGet(0.0f ,-0.1f ,2.34f),"Resource/WeaponUI/PIS.png","Resource/Sound/FirePIS.ogg","Resource/Sound/Reload.wav","Resource/Sound/Reloadend.wav"} };
}
namespace ENEMY_GUN {
